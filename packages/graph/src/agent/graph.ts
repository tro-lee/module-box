 ...
 */
async function callModel(state: typeof StateAnnotation.State, _config: RunnableConfig): Promise<typeof StateAnnotation.Update> {
  /**
 ...
 */
export function route(state: typeof StateAnnotation.State): '__end__' | 'callModel' {
